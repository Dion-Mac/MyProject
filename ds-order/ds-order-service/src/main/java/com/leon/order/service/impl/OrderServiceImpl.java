package com.leon.order.service.impl;
...
import com.leon.order.client.GoodsClient;
import com.leon.order.interceptor.LoginInterceptor;
import com.leon.order.mapper.*;
import com.leon.order.service.OrderService;
import com.leon.order.service.OrderStatusService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResult<Order> queryUserOrderList(Integer page, Integer rows, Integer status) {
        try{
            ...
            return new PageResult<Order>(pageInfo.getTotal(),orderList,pageInfo.getPages());
        }catch (Exception e){
