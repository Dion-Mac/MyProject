package com.leon.comments.service.impl;

import com.leon.comments.pojo.Review;
import com.leon.comments.client.OrderClient;
import com.leon.comments.service.CommentService;
import com.leon.comments.bo.CommentRequestParam;
import com.leon.comments.dao.CommentDao;
...
public class CommentServiceImpl implements CommentService {
    ...
    public boolean add(Long orderId,Review review) {
        ...
        //2.修改订单状态,6代表评价状态
        boolean result = this.orderClient.updateOrderStatus(orderId, 6);
        if (!result){
            return false;
        }
        //3.添加评论
